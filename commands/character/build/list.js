...
• **/mog character ${charactername} build levelup
  This command level your character by one, assuming you have enough experience points.
  ...
  This command will check if your character is valid for a given storyteller's world.`);
    if (message.guild.id) {
        const embed = new Discord.RichEmbed()
            ...
            .setColor(0x7D3C98)
            .setDescription(`Direct message sent to **${ message.author.username }**, kupo! Good luck~`)
